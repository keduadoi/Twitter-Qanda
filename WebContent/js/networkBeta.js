...
{  
   ...
   $.ajax(network_page.script_location,
		...
		//2011-04-23 12:00:00, 2011-04-23 12:59:59
			data: {filename:'tweets_single_lines.dat', nclasses: network_page.num_classes, hashtagjson: JSON.stringify(hashtags_json),num_nodes:numnodes},
			dataType: 'json',
			...
			//d3.json("data.json", function(error, graph) {
			  ...
			  var node = svg.selectAll(".node")
			      ...
			      .enter().append("circle")
			      .attr("class", "node")
			      .attr("r", function(n){return (n.group+1)*5;})
			      .style("fill", function(d) { return d.catColor;})
			      .call(force.drag);
