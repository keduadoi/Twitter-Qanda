...
import Chapter5.network.CreateD3Network;
...
//	                     "attachment;filename=tweets.txt");
		...
		String filePath = "C:" + File.separator + "temp" + File.separator + "tweets.json";
...
//		} 
		...
		for(int i=0;i<rawTweetsArray.length();++i){
			try {
				printWriter.println(rawTweetsArray.getJSONObject(i).toString());
				printWriter.flush();
			} catch (JSONException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
